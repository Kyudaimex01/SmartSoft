        ...
        <ul class="slides-container">
            <li>
                ...
                <div class="description" >
                    <h2 class="description__title">BIENVENIDOS</h2>
            ...
            <li>
                ...
                <div class="description" >
                    <h2 class="description__title">VISION</h2>
            ...
            <li>
                ...
                <div class="description" >
                    <h2 class="description__title">MISION</h2>
            ...
            <li>
                ...
                <div class="description" >
                    <h2 class="description__title">ACTIVIDAD PRINCIPAL</h2>
