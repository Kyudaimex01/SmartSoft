...
<!--<section class="pages container">
    <div class="page page-about">
        <h1 class="text-capitalize">NOSOTROS</h1>
        <cite> SMART SOFT COMO SITIO DE CONFERENCIAS DE TECNOLOGÍAS </cite>
        <div class="divider-2" style="margin: 35px 0;"></div>
        <br>Smart Soft con varias novedades que incluyen la norma global "Conozca a su cliente" en su haber. Marcada con plataformas y productos que han transformado la manera en que operan las empresas.</p>
        <p>  </p>
        <p>El enfoque actual está en una plataforma de incubación de futuro, creada para catapultar las ciencias de la computacion , una de las aplicaciones con más novedosas.</p>
    </div>
</section>-->
...
<!<section class="posts container">
    <article class="post w-image">
        ...
        <div class="page page-about">
            ...
            <cite> SMART SOFT COMO SITIO DE CONFERENCIAS DE TECNOLOGÍAS </cite>
            <div class="divider-2" style="margin: 35px 0;"></div>
            <p>Smart Soft con varias novedades que incluyen la norma global "Conozca a su cliente" en su haber. Marcada con plataformas y productos que han transformado la manera en que operan las empresas.<br></p>
            <p>  </p>
            <p>El enfoque actual está en una plataforma de incubación de futuro, creada para catapultar las ciencias de la computacion , una de las aplicaciones con más novedosas.</p>
        </div>
    </article>
        ...
        <div class="content-post">
            <header class="container-flex space-between">
                ...
                <div class="post-category">
                    <span class="category text-capitalize">nuestra galeria</span>
                </div>
            </header>
            <h1>El conocimiento al alcance de tus manos</h1>
...
<!--    <article class="post w-video">
        ...
        <div class="content-post">
            ...
            <h1>videos aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</h1>
            <div class="divider"></div>
            <footer class="container-flex space-between">
                <div class="tags container-flex">
                    <span class="tag c-gray-1">#Yosemite</span>
    ...
    </article>  --><!--esta linea de codigo tiene que ver con el video-->
